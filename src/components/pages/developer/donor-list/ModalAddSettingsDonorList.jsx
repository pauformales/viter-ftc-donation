...
const ModalAddSettingsDonorList = ({ itemEdit, setIsModal }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/rest/v1/controllers/developer/donor-list/donor-list/donor-list.php?donorid=${itemEdit.donot_list_aid}`
          : `/rest/v1/controllers/developer/donor-list/donor-list/donor-list.php`,
        itemEdit ? "PUT" : "POST",
        values
      ),
    onSuccess: (data) => {
...
export default ModalAddSettingsDonorList;
